...
export const EducationConsultant = () => {
    ...
    const handleCheckboxChange = (option) => {
        if (formData.selectedOptions.includes(option)) {
            ...
            setFormData((prevData) => ({
                ...
                ...(option === 'GRE' && { greValues: { AWA: '', Quantitative: '', Verbal: '' } }),
    ...
    const isFormValid = () => {
        const formFields = Object.keys(formData).filter(
            key => key !== 'greValues' && key !== 'ieltsValue' && key !== 'tofelValue'
        );
                        ...
                        <div className="row g-2">
                            ...
                            <div className="col col-auto">
                                ...
                                <div className="dropdown">
                                    <select value={formData.schoolGradeType} onChange={(e) => handleChange("schoolGradeType", e.target.value)} className="btn btn-secondary dropdown">
                                        <option className="bg-white text-black" value="CGPA">CGPA</option>
                                        <option className="bg-white text-black" value="Percentage">Percentage</option>
                                    </select>
                                </div>
                            </div>
                            <InputField
                                ...
                                setError={(error) => handleFieldError(formData.schoolGradeType, error)}
                            />
                            <InputField
                                name="studyYear"
                                ...
                                onChange={(e) => handleChange("schoolGraduateYear", e.target.value)}
                    ...
                    <div className="my-3">
                        ...
                        <div className="row g-2">
                            ...
                            <div className="col col-auto">
                                <label className="mb-1">Grading type</label>
                                <div className="dropdown">
                                    <select value={formData.middleGradeType} onChange={(e) => handleChange("middleGradeType", e.target.value)} className="btn btn-secondary dropdown">
                                        <option className="bg-white text-black" value="CGPA">CGPA</option>
                                        <option className="bg-white text-black" value="Percentage">Percentage</option>
                                    </select>
                                </div>
                            ...
                            <InputField
                                ...
                                setError={(error) => handleFieldError(formData.middleGradeType, error)}
                            />
                            <InputField
                                name="studyYear"
                                label="Graduation year"
                                ...
                                onChange={(e) => handleChange("middleGraduateYear", e.target.value)}
                                setError={(error) => handleFieldError("studyYear", error)}
                            />
                        </div>
                    </div>
                    <div className="my-3">
                        ...
                        <div className="row row-cols-2 row-cols-lg-4 row-cols-md-4">
                            <div className="col">
                                <label className="mb-1">Grading type</label>
                                <div className="dropdown">
                                    <select value={formData.bachelorGradeType} onChange={(e) => handleChange("bachelorGradeType", e.target.value)} className="btn btn-secondary dropdown w-100">
                                        <option className="bg-white text-black" value="CGPA">CGPA</option>
                                        <option className="bg-white text-black" value="Percentage">Percentage</option>
                                    </select>
                                </div>
                            ...
                            <InputField
                                ...
                                setError={(error) => handleFieldError(formData.bachelorGradeType, error)}
                            />
                            <div className="col">
                                <label className="mb-1">Branch/Stream <span className="text-danger">*</span></label>
                                <div className="dropdown">
                                    <select
                                        value={formData.branchStream}
                                        onChange={(e) => handleChange("branchStream", e.target.value)}
                                    ...
                                    >
                                        ...
                                        {bTechBranches.map((branch, index) => (
                                            <option key={index} className="bg-white text-black" value={branch}>
                                                {branch}
                                            </option>
                                        ))}
                                    </select>
                            ...
                            <InputField
                                ...
                                onChange={(e) => handleChange("bachelorGraduateYear", e.target.value)}
                                setError={(error) => handleFieldError("studyYear", error)}
                            />
                        </div>
                    </div>
                                ...
                                {formData.selectedOptions.includes('GRE') && (
                                    <div className='row'>
                                        ...
                                        <InputField
                                            ...
                                            onChange={(e) => handleInputChange('Quantitative', e.target.value)}
                                            setError={(error) => handleFieldError("score", error)}
                                        />
                                        <InputField
                                            name="score"
