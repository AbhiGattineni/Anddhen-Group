        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-8 my-auto">
              <h6 className="float-end">Home/Terms and Conditions</h6>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="policy-content" style={{ lineHeight: '1.8', textAlign: 'justify' }}>
            ...
            <p>
              ...
              with these Terms of Use are expressly rejected by the Platform Owner and shall be of
              no force or effect. These Terms of Use can be modified at any time without assigning
              any reason. It is your responsibility to periodically review these Terms of Use to
            ...
            <p>
              <strong>
                ...
                THE TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE
            ...
            <ol>
              ...
              <li>
                The contents of the Platform and the Services are proprietary to us and are licensed
                to us. You will not have any authority to claim any intellectual property rights,
                title, or interest in its contents. The contents includes and is not limited to the
              ...
              <li>
                You agree and acknowledge that website and the Services may contain links to other
                third party websites. On accessing these links, you will be governed by the terms of
                use, privacy policy and such other policies of such third party websites. These
              ...
              <li>
                ...
                breach of this Terms of Use, privacy Policy and other Policies, or Your violation of
                any law, rules or regulations or the rights (including infringement of intellectual
                property rights) of a third party.
              </li>
              <li>
                Notwithstanding anything contained in these Terms of Use, the parties shall not be
              ...
              <li>
                ...
                the exclusive jurisdiction of the courts in Jaggayyapet and Andhra Pradesh.
              </li>
              <li>
