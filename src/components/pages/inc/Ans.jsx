        ...
        <div className="mt-5 p-3 rounded bg-light">
          <Container>
            <p className="p-2" style={{ textAlign: 'justify' }}>
              ...
              NRIs who wish to stay connected with India. Whether you need to manage tasks for your
              family, send gifts on special occasions, or require assistance with any other needs in
              India, we are here to help you every step of the way. We understand the challenges of
              being far away and the desire to maintain a strong bond with your home country.
            </p>
            <p className="p-2" style={{ textAlign: 'justify' }}>
              Our services extend to assisting NRIs in supporting their families back home. From
              handling essential tasks for your parents and relatives to arranging timely deliveries
              for festivals and birthdays, we ensure that your presence is felt even when you are
              miles away.
            </p>
          </Container>
        </div>
              ...
              <Card className="border-0 shadow-lg">
                <Card.Body>
                  <div
                    ...
                    style={{ width: '60px', height: '60px' }}
                  >
                    <i className="bi bi-gift" style={{ fontSize: '1.5rem' }}></i>
                  </div>
                  <Card.Title className="text-dark">Gifts & Surprises</Card.Title>
                  <Card.Text className="text-secondary">
            ...
            <Col xs={12} md={3} className="text-center mb-4">
              <Card className="border-0 shadow-lg">
                <Card.Body>
                  ...
                  <Card.Text className="text-secondary">
                    All-in-one support for managing tasks in India, from family care to sending
                    gifts.
                  </Card.Text>
                </Card.Body>
              </Card>
