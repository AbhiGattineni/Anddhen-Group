        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-md-10 col-lg-9">
              ...
              <p className="p-2" style={{ textAlign: 'justify' }}>
                The <strong>ANDDHEN - JAYA LAKSHMI FOUNDATION</strong> is a
                labor of love, a profound homage to my cherished grandmother,{' '}
                <strong>Jaya Lakshmi</strong>, who is alive and continues to
                inspire us. As a devoted government school headmistress, she
                dedicated her life to nurturing and educating countless
                children, instilling in them the values of knowledge, integrity,
                and compassion. Her relentless commitment to education and her
                selfless care for others have profoundly influenced my life,
              ...
              <p className="p-2" style={{ textAlign: 'justify' }}>
                ...
                <strong>ANDDHEN - JAYA LAKSHMI FOUNDATION</strong> is dedicated
                to this noble cause, striving to ensure that no child is
                deprived of the opportunity to learn and grow due to financial
                hardship.
              </p>
              <p className="p-2" style={{ textAlign: 'justify' }}>
                By providing scholarships, resources, and support, we aim to
                transform the lives of these young learners, giving them the
                chance to achieve their fullest potential and contribute
                positively to society. We are not just funding education; we are
                nurturing dreams, fostering hope, and building a foundation for
                a brighter tomorrow.
              </p>
              <p className="p-2" style={{ textAlign: 'justify' }}>
                ...
                <strong>ANDDHEN - JAYA LAKSHMI FOUNDATION</strong>, we aspire to
                extend her legacy of compassion and generosity to children who
                need it the most.
              </p>
              <p className="p-2" style={{ textAlign: 'justify' }}>
                Each contribution to this foundation is a step toward creating a
