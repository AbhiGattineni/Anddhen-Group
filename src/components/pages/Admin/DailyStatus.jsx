...
/**
 * Daily status update — calendar, submission form and the user's status table.
 *
 * Lifted verbatim out of EmployeeDashboard: the dashboard is a grid of cards
 * now, and this is the page behind the Timesheet card rather than something
 * every employee is shown on landing.
 */
const DailyStatus = () => {
  const empName = '';
