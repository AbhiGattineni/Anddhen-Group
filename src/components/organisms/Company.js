        ...
        <div className="row">
          <div className="col-md-12 text-center">
            ...
            <p>
              ...
              we are also committed to making a difference through our
              philanthropic endeavors. We believe in the power of giving back
              and are actively involved in various initiatives that contribute
              to the betterment of communities and foster sustainable
              development.
            </p>
            <p>
              Whether you are seeking cutting-edge software solutions, expert
            ...
            <p>
              <b>
                Choose Anddhen, where our services meet your ambition, and
                together, we create not just success, but a legacy of positive
                impact.
              </b>
            </p>
            <Link to="/about" className="btn btn-warning shadow">
